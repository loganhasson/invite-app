  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved invite as @invite" do
        ...
        post :create, {:invite => { "event_id" => "invalid value" }}, valid_session
        assigns(:invite).should be_a_new(Invite)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested invite" do
        ...
        Invite.any_instance.should_receive(:update).with({ "event_id" => "1" })
        put :update, {:id => invite.to_param, :invite => { "event_id" => "1" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the invite as @invite" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Invite.any_instance.stub(:save).and_return(false)
        put :update, {:id => invite.to_param, :invite => { "event_id" => "invalid value" }}, valid_session
        assigns(:invite).should eq(invite)
      end
